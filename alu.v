...
input [3:0] ctl ; 
case ( ctl ) 
  4'b0000: alu_out=b;             //Select data on port B [BUG]
  ...
  4'b0101: alu_out=a-b;           //SUB without BORROW[BUG] 
  4'b0110: alu_out=a-b+(~cin);    //SUB with BORROW 
  4'b0111: alu_out=a&b;           //AND 
  4'b1000: alu_out=a|b;           //OR 
  4'b1001: alu_out=a^b;           //XOR 
  4'b1010: alu_out={b[2:0],1'b0}; //Shift Left[BUG] 
  4'b1011: alu_out={1'b0,b[3:1]}; //Shift Right 
  4'b1100: alu_out={b[2:0],b[3]}; //Rotate Left 
  4'b1101: alu_out={b[0],b[3:1]}; //Rotate Right 
  default : begin 
    alu_out=4'bXXXX; 
...
input [4:0] a4 ; 
begin 
z_flag = ~|a4; // zero flag check for a4 
end 
endfunction 
endmodule